...
const userCommentData = [
	{
		...
		time: "20 mins ago",
		comment:
			"Andretti would do miles better tha williams with better facilites and backing to improve them.",
		like: "12",
	},
	{
		username: "manishmh1",
...
const userCommentReply = [
	{ username: "manishmh00", time: "20 mins ago", comment: "This is comment reply", like: "12" },
	{
		username: "manishmh11",
		time: "20 mins ago",
		comment: "This is also a comment reply",
		like: "12",
	},
];
...
function splitString(str) {
	...
	const firstSubstring =
		str.slice(0, periodIndices[1] + 1) + str.slice(periodIndices[2] + 1, periodIndices[3] + 1);
		...
		<>
					...
					<div className="post-img_container">
						...
						<div className="gradient-title_container">
							<h3 className="post-title">
								The FIA president has revealed he is looking to expand the Formula 1
								grid by appealing for expressions of interest for potential new
								teams.
							</h3>
						</div>
					</div>
			...
			<div className="comment-section">
				...
				<div className="users-comment_container">
					...
					<Comment
						username={userCommentData[0].username}
						time={userCommentData[0].time}
						comment={userCommentData[0].comment}
						like={userCommentData[0].like}
					/>
					<CommentReply
						username={userCommentReply[0].username}
						time={userCommentReply[0].time}
						comment={userCommentReply[0].comment}
						like={userCommentReply[0].like}
					/>
					{comment &&
